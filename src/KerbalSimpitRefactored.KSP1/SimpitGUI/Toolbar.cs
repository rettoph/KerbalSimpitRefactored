...
namespace KerbalSimpitRefactored.Unity.KSP1.SimpitGUI
{
    // Start at main menu
    ...
    public class AppButton : SimpitBehaviour
    {
        ...
        public override void Start()
        {
            ...
            iconRed = GameDatabase.Instance.GetTexture("KerbalSimpitRefactored/Simpit_icon_red", false);
            iconOrange = GameDatabase.Instance.GetTexture("KerbalSimpitRefactored/Simpit_icon_orange", false);
            iconGreen = GameDatabase.Instance.GetTexture("KerbalSimpitRefactored/Simpit_icon_green", false);
