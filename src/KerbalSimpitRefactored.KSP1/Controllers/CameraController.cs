        ...
        ISimpitMessageSubscriber<CameraTranslationCommandMessage>
    {
        ...
        public void Process(SimpitPeer peer, ISimpitMessage<CameraModeCommandMessage> message)
        {
            ...
            switch (message.Data.Value)
            {
                ...
                case CameraModeEnum.FlightMode:
                    CameraManager.Instance.SetCameraFlight();
                    break;
                case CameraModeEnum.IVAMode:
                    CameraManager.Instance.SetCameraIVA();
                    break;
                case CameraModeEnum.PlanetaryMode:
                        ...
                        case CameraManager.CameraMode.Flight:
                            ...
                            switch (message.Data.Value)
                            {
                                ...
                                case CameraModeEnum.Locked:
                                    ...
                                    break;
                                case CameraModeEnum.NextCameraModeState:
                                    ...
                                    break;
                                case CameraModeEnum.PreviousCameraModeState:
